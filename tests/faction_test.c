...
void allocate_faction_test() {
    ...
    CU_ASSERT_EQUAL(faction->name, "Facção 01");        // Testa se 'faction->name' é "Facção 01";
    ...
    CU_ASSERT_PTR_NOT_NULL(faction);                    // Testa se 'faction' não é um ponteiro 'NULL';
    CU_ASSERT_EQUAL(faction->name, "Facção 02");        // Testa se 'faction->name' é "Facção 02";
...
void insert_faction_test(){
    ...
    CU_ASSERT_EQUAL(factions->name, "Facção 01");       // Testa se 'faction->name' é "Facção 02";
    ...
    CU_ASSERT_EQUAL(factions->name, "Facção 02");       // Testa se 'faction->name' é "Facção 02";
